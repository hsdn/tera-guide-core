		...
		switch (page) {
			default:
				tmpData.push(
					...
					{ text: `<font color="${mod.settings.spawnObject ? gcg : gcr}" size="+18">[${lang.strings.spawnObject}]</font>`, command: "guide spawnObject;guide gui" }, { text: "&nbsp;&nbsp;" },
					{ text: `<font color="${mod.settings.speaks ? gcg : gcr}" size="+18">[${lang.strings.speaks}]</font>`, command: "guide voice;guide gui" },
					{ text: "<br>&#09;&#09;&#09;&#09;&#09;" },
					{ text: `<font color="${mod.settings.lNotice ? gcg : gcr}" size="+18">[${lang.strings.lNotice}]</font>`, command: "guide lNotice;guide gui" }, { text: "&nbsp;&nbsp;" },
					{ text: `<font color="${mod.settings.stream ? gcg : gcr}" size="+18">[${lang.strings.stream}]</font>`, command: "guide stream;guide gui" }, { text: "&nbsp;&nbsp;" },
					{ text: `<br><br>` },
					...
					{ text: `<font size="+18">[${lang.strings.test}]</font>`, command: "guide guivoicetest" },
					{ text: `<br>` }
				);
				...
				for (const [id, dungeon] of Object.entries(mod.settings.dungeons)) {
					...
					tmpData.push({ text: `<font color="${dungeon.spawnObject ? gcg : gcr}" size="+18">[${lang.strings.objects}]</font>`, command: "guide spawnObject " + id + ";guide gui" }, { text: "&nbsp;&nbsp;" });
					tmpData.push({ text: `<font color="${dungeon.verbose ? gcg : gcr}" size="+18">[${lang.strings.verbose}]</font>`, command: "guide verbose " + id + ";guide gui" }, { text: "&nbsp;&#8212;&nbsp;" });
